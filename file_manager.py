...
def process_user_command(choice, # TODO - Set the keyword arguments such that  
running, show_goodbye=True, # 1. show_goodbye defaults to True
...
invalid_chooice_prefix='invalid choice:', # 3. invalid_choice_prefix defaults to "Invalid choice:"
